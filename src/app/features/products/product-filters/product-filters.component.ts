...
export class ProductFiltersComponent implements OnInit {
  ...
  readonly brands = ['Nike', 'Adidas', 'Puma', 'Reebok', 'New Balance'];
  readonly sizes = ['SIZE_38', 'SIZE_39', 'SIZE_40', 'SIZE_41', 'SIZE_42', 'SIZE_43', 'SIZE_44', 'SIZE_45'];
  readonly colors = ['Black', 'White', 'Blue', 'Grey', 'Brown', 'Red'];
